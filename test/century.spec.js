...
test('bigmoment century test', t => {
	...
	t.is(bigmoment('-1999').century(), -10);
	t.is(bigmoment('100').century(), 11);
	t.is(bigmoment('1000').century(), 11);
	t.is(bigmoment('-2000').century(), -20);
	t.is(bigmoment('-200').century(), -21);

	// t.is(bigmoment('0').century({format: 'ordinal'}), "1st CE");
	// t.is(bigmoment('-0').century({format: 'ordinal'}), "1st BCE");
	// t.is(bigmoment('00').century({format: 'ordinal'}), "1st CE");
	// t.is(bigmoment('-00').century({format: 'ordinal'}), "1st BCE");
	// t.is(bigmoment('010').century({format: 'ordinal'}), "1st CE");
	// t.is(bigmoment('0000').century({format: 'ordinal'}), "1st CE");
	// t.is(bigmoment('-0000').century({format: 'ordinal'}), "1st CE");
	// t.is(bigmoment('-0001').century({format: 'ordinal'}), "1st BCE");
	// t.is(bigmoment('0100').century({format: 'ordinal'}), "1st CE");
	// t.is(bigmoment('-0100').century({format: 'ordinal'}), "1st BCE");
	// t.is(bigmoment('1000').century({format: 'ordinal'}), "2nd CE");
	// t.is(bigmoment('-1000').century({format: 'ordinal'}), "1st BCE");
	// t.is(bigmoment('2340').century({format: 'ordinal'}), "3rd CE");
	// t.is(bigmoment('-2340').century({format: 'ordinal'}), "3rd BCE");
	// t.is(bigmoment('-9999').century({format: 'ordinal'}), "10th BCE");
});
